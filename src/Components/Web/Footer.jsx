...
const Footer = () => {
  return (
    <footer className="bg-white w-full p-12 px-4 sm:px-12 lg:px-32 xl:px-50">
        ...
        <section className="flex justify-between items-center flex-col sm:flex-row gap-3">
            ...
            <div className="flex gap-3">
                ...
                <FaInstagram className="text-2xl cursor-pointer" onClick={()=>{
                    window.open("https://www.instagram.com/ghani726x")
                }} />
                <FaFacebook className="text-2xl cursor-pointer" onClick={()=>{
                    window.open("https://www.facebook.com/ghani726")
                }} />
            </div>
        </section>
    </footer>
